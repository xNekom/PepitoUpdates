...
serve(async (req: Request) => {
  ...
  const corsHeaders = {
    ...
    'Access-Control-Allow-Headers': requestedHeaders || 'authorization, x-client-info, x-api-version, apikey, content-type, x-user-id, x-session-id, x-app-version, x-client-platform, x-request-id, x-cache-type, x-cache-strategy, user-agent',
